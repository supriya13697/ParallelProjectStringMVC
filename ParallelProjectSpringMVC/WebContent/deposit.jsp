...
<body>
	<center>
		<div
			...
			<dep:form name="add" action="depositNow" modelAttribute="deposit" method="post" onsubmit="return formValidation()">
				<h1>
					<u>Deposit money</u>
				</h1>
				<table>
