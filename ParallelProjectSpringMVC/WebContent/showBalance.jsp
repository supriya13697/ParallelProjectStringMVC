...
<body>
	<center>
		<div style="border-radius: 15px; padding: 20px; width: 600px; box-shadow: 5px 5px 5px 5px silver;">
			<show:form name="add" action="showBalanceNow" method="post" modelAttribute="showBal" onsubmit="return formValidation()">
			<h1><u>Show user's balance</u></h1>
				<table>
					<tr>
						<td>Mobile number:</td>
						<td><show:input path="mobileNumber" id="mob" name="mobile" pattern = "[7-9][0-9]{9}" title="Mobile number should have 10 digits and the starting digit should be 7 or 8 or 9" placeholder="Enter mobile number"/><br></td>
					</tr>
					<tr align="right">
						<td></td>
