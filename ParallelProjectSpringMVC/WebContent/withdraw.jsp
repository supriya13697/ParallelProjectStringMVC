...
<body>
	<center>
		<div
			...
			<with:form name="add" action="withdrawNow" modelAttribute="withdraw" method="post" onsubmit="return formValidation()">
				<h1>
					<u>Withdraw money</u>
				</h1>
				<table>
